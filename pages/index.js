...
export default function Index() {
  return (
    <main className="min-h-screen md:grid md:grid-cols-3 lg:grid-cols-12 md:gap-6">
      <div className="flex items-center min-h-screen px-4 py-10 md:col-span-1 lg:col-span-5">
      ...
      <div className="md:col-span-2 lg:col-span-7">
        <section className="flex flex-col justify-between min-h-screen px-4 text-yellow-900 bg-yellow-300">
          ...
          <ul className="flex items-center justify-end py-5 space-x-5 lg:px-8 ">
            <li>
              <a href="#">
                <Icon
                  icon="github"
